    ...
    <section className="vision-section">
      <div className="vision-mosaic">
        <div className="mosaic-landscape">
          ...
          <span className="image-caption">Rapid Diagnostic Solutions</span>
        </div>
        ...
        <div className="mosaic-portrait">
          ...
          <span className="image-caption">AI Vision Infrastructure</span>
      ...
      <div className="vision-statement-container">
        <div className="vision-statement fade-in-up" ref={textRef}>
          ...
          <h2>Our vision is to eradicate child malnutrition by empowering clinicians with AI-driven diagnostic insights.</h2>
        </div>
      </div>
    </section>
  );
